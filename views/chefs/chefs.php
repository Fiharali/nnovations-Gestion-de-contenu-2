                        ...
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="name"
                                    ...
                                    placeholder="<?php echo  $lang['placeholderName'] ?>">
                            </div>
                            <div class=" sm:col-span-2">
                                <label for="age" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                    <?php echo  $lang['ChefAge'] ?></label>
                                <input type="number	" value="<?php echo isset($_POST['age']) ? $_POST['age'] : ''; ?>"
                                    name="age" id="age"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="<?php echo  $lang['placeholderEmail'] ?>"">
							</div>
                        ...
                        <div class="py-1 px-4 mx-auto max-w-2xl lg:py-16">
                            <form method="post">
                                ...
                                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                    ...
                                    <div class=" sm:col-span-2">
                                        <label for="age"
                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><?php echo  $lang['ChefAge'] ?></label>
                                        <input type="number	" value="<?= $row['age'] ?>" name="age" id="age"
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                            placeholder="Type Employe email">
                                    </div>
                                    <div class="sm:col-span-2 mt-12">
