...
<body>
   ...
   <header class="container-fluid first-section">
      <nav class="navbar navbar-expand-lg ">
         <div class="container">
            <a class="navbar-brand " href="#"><img src="../../images/logo3 1.png" alt="sq" ></a>
            ...
            <div class="collapse navbar-collapse " id="navbarNavDropdown">
               <ul class="navbar-nav me-5">
                  ...
                  <li class="nav-item me-5 ">
                     <a class="nav-link hoverAfter " aria-current="page" href="../Service/Service.html">Services </a>
                  </li>
                  <li class="nav-item me-5">
   ...
   <div class="image-container">
      <div><img src="../../images/crop-plate-with-salad.jpg" alt="crop-plate-with-salad"></div>
   ...
   <section class="firstsection-about" data-aos="fade-left">
      ...
      <video src="../../images/videoplayback.mp4" controls poster="../../images/restaurant-interior.jpg" data-aos="fade-right"></video>
   </section>
   <section class="WhatWe-Do">
      <h1 data-aos="zoom-in" >What We Do </h1>
      <div class="cards-about">
         <div class="card" style="width: 14rem;">
            <img src="../../images/healthy-food.png" class="card-img-top" alt="...">
            <div class="card-body">
         ...
         <div class="card" style="width: 14rem;">
            <img src="../../images/chef (3).png" class="card-img-top" alt="...">
            <div class="card-body">
               <h5>Skilled Shef</h5>
               <p class="card-text"> hihihiu ufytfse</p>
            </div>
         ...
         <div class="card" style="width: 14rem;">
            <img src="../../images/cocktail (1).png" class="card-img-top" alt="...">
            <div class="card-body">
               <h5>Best Bar</h5>
         ...
         <div class="card" style="width: 14rem;">
            <img src="../../images/cuisine (1).png" class="card-img-top" alt="...">
            <div class="card-body">
               <h5>Vegan Cuisine</h5>
   ...
   <section class="meetourtteam-about">
      ...
      <div class="ourteam-about">
         ...
         <div class="imagecards">
            <img src="../../images/Acharouaou.jpg" alt="Acharouaou">
         ...
         <!-- the second card A.F -->
         <div class="imagecards">
            <img src="../../images/Fihar.jpg" alt="Fihar">
            <div class="insideimage-container">
               <div class="name-job-clickicon">
                  <div class="name-job">
         ...
         <!-- the third card A.T -->
         <div class="imagecards">
            <img src="../../images/Taouil.jpg" alt="Taouil">
            <div class="insideimage-container">
               <div class="name-job-clickicon">
                  <div class="name-job">
         ...
         <!-- the forth card I.B -->
         <div class="imagecards">
            <img src="../../images/Ibtihal.jpg" alt="Ibtihal">
            <div class="insideimage-container">
               <div class="name-job-clickicon">
                  <div class="name-job">
